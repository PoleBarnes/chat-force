...
## Scout (Daily at 10 AM)

Research new tools and capabilities:
1. Scan Twitter/X, HN, Product Hunt for relevant AI releases
2. Evaluate relevance to current platform capabilities
3. Propose experiments for promising findings
4. Track results from previous experiments
5. Recommend integration when evidence is strong (3+ successes)

Post findings as a brief in the admin channel. Integration proposals need Travis's approval.
