...
The command execution allowlist in `security/exec-approvals.json` contains a
...
volumes:
  - ./security/exec-approvals.json:/config/exec-approvals.json:ro
  - ./base-config.yaml:/config/base-config.yaml:ro
```
